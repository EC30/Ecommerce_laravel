...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('user_assests/css/slick.css')}}" />
                ...
                <div class="col-md-3">
                    <div class="card product-card" style="width:400px;height:400px;">
                        <div class="product-image position-relative">
                            @if($product->product_image->isNotEmpty())
                            @foreach($product->product_image as $pimages)
                            <a href="" class="product-img"><div class="left" style="width: 200px; height: 200px; background-image: url('{{ asset('temp/' . $pimages->image) }}'); background-size: cover;background-position: center center;"></div></a>
                            @endforeach
                            @else
